...
Terraform — инструмент управления [[IaC|инфраструктурой как кодом]]: один файл спецификации позволяет автоматически развернуть из него готовую инфраструктуру.

- Terraform реализует декларативное управление инфраструктурой.
  - **Ansible** ([[ansible|Ansible]]) реализует императивное управление инфраструктурой.
- Спецификации Terraform можно упаковать в образы [[containerization|виртуальной машины]] при помощи [[packer|Packer]].
