...
1. Позволяет разработчикам сфокусироваться на работе над кодом: больше не нужно разворачивать, настраивать и обслуживать какую-либо инфраструктуру (серверы, виртуальные машины, [[containerization|контейнеры]]).
...
[[yandex-serverless-integrations|Yandex Serverless integrations]]
