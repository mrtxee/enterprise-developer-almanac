...
aliases:
  ...
  - Logstash
---
## Grok в [[logstash|Logstash]] — полное руководство

### Что такое Grok

**Grok** — это фильтр в [[logstash|Logstash]], который позволяет парсить и структурировать неструктурированные логовые данные с помощью шаблонов на основе регулярных выражений. Название "grok" происходит из научной фантастики и означает "понять что-то глубоко и интуитивно".
