...
| Слой | Компоненты |
|------|------------|
| **Агенты и экспортеры** | Node Exporter, Application Metrics |
| **Система сбора и хранения** | Prometheus, InfluxDB, Elasticsearch, Time series DB |
| **Визуализация и оповещения** | Grafana, Alertmanager, PagerDuty, Slack Webhooks |
...
2. **Сложность масштабирования**: рост объёма метрик
