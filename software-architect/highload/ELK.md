...
**ELK-стек** (теперь чаще называют **Elastic Stack**) — набор инструментов с открытым исходным кодом для сбора, хранения, анализа и визуализации логов и других данных. Название складывается из первых букв трёх основных компонентов: **[[elastic-search|Elasticsearch]]**, **[[logstash|Logstash]]**, **[[kibana|Kibana]]**. Позже к ним добавился **Beats** — лёгкий агент сбора данных.
...
1. **[[elastic-search|Elasticsearch]]**
...
2. **Обработка**
   ...
   - При необходимости применяет преобразования ([[grok|Grok]], JSON, CSV).
...
- **Гибкость**: поддержка разных форматов (JSON, CSV, [[syslog|Syslog]]).
...
- **Развёртывание**: [[Docker|Docker]], [[kubernetes|Kubernetes]], облачные сервисы (Elastic Cloud), bare metal.
