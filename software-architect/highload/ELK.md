...
**ELK-стек** (теперь чаще называют **Elastic Stack**) — набор инструментов с открытым исходным кодом для сбора, хранения, анализа и визуализации логов и других данных. Название складывается из первых букв трёх основных компонентов: **[[Elasticsearch|Elasticsearch]]**, **[[logstash|Logstash]]**, **[[kibana|Kibana]]**. Позже к ним добавился **Beats** — лёгкий агент сбора данных.
