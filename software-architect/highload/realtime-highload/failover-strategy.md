...
Каждый регион имеет **свой кластер [[kubernetes|Kubernetes]]**, свои базы, свои DNS. Трафик направляется к **ближайшему региону** через **DNS-балансировку** (например, AWS Route53, Cloudflare). Данные реплицируются **асинхронно** между регионами.
