...
```mermaid
---
title: Архитектура OpenTelemetry
---
graph LR
...
> *“If you're not using OpenTelemetry — you're behind.”*
...
- **Ключевой элемент: Span**. Каждый Span представляет собой отдельную логическую операцию в рамках запроса (например, вызов API или запрос к базе данных). Span содержат такую информацию, как идентификатор операции, временные метки начала и окончания, атрибуты и ссылки на другие Span.
