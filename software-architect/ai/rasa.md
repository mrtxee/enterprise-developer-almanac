...
**Rasa** — это открытый (open‑source) фреймворк [[machine-learning|машинного обучения]] для разработки чат‑ботов и виртуальных ассистентов с продвинутым пониманием естественного языка.
...
1. **Rasa Open Source** (ядро фреймворка):
   - **[[nl-understanding|NLU]] (Natural Language Understanding)** — распознавание намерений (intents) и сущностей (entities) в сообщениях пользователя;
   - **[[dialog-management|Dialogue Management]]** — управление ходом диалога, принятие решений о следующем действии бота.
...
1. **Обработка ввода ([[nl-understanding|NLU]])**:
...
- **Настраиваемые ML‑модели** — возможность [[fine-tuning|дообучения]] под специфику домена.
