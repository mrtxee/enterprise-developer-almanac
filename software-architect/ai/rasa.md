...
1. **Rasa Open Source** (ядро фреймворка):
   - **[[nl-understanding]] (Natural Language Understanding)** — распознавание намерений (intents) и сущностей (entities) в сообщениях пользователя;
...
1. **Обработка ввода ([[nl-understanding]])**:
