...
**[[machine-learning|Machine learning]]** evolves by learning from data
...
1. **Сильный ИИ** (Strong AI / Artificial General Intelligence, [[agi|AGI]])
...
2. **Машинное обучение** (Machine Learning, [[machine-learning|Machine learning]])
...
2. **Обработка естественного языка** ([[nl-processing|NLP]])
   - машинный перевод;
   - чат‑боты;
   - анализ тональности.
...
- **Большие языковые модели** ([[machine-learning-model|LLM]], например GPT, Llama);
- **[[machine-learning-model|Генеративные модели]]** (GAN, Diffusion Models);
...
```mermaid
---
title: Пересечение AI и Data Science
---
graph TD
