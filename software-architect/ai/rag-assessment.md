...
```mermaid
---
title: Архитектура RAGAS
---
flowchart TB
  subgraph Input["Входные данные"]
    A1[Question — вопрос пользователя]
    A2[Ground Truth — ожидаемый ответ]
    A3[Retrieved Documents — документы из retriever]
    A4[Generated Answer — сгенерированный ответ LLM]
  end
  subgraph Framework["RAGAS Evaluation Framework"]
    B1[Faithfulness — Верность]
    B2[Answer Relevance — Релевантность ответа]
    B3[Context Relevance — Релевантность контекста]
    B4[Aspect-Specific Metrics]
  end
...
**Расчёт при наличии ground truth**
...
3. **Интеграция** — работает с популярными [[machine-learning|ML]] инструментами
