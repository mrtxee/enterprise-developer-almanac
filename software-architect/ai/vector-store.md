...
RAG-системы (Retrieval-Augmented Generation) используют векторные хранилища (vector databases) для поиска по эмбеддингам. Ниже — сравнение четырёх популярных решений: **FAISS**, **Pinecone**, **Qdrant**, **ChromaDB**.
...
## Выбор хранилища векторных данных
...
```mermaid
---
title: Архитектура RAG с векторным хранилищем
---
graph TD
...
> *«Chroma is for learning. Qdrant is for production.»*
