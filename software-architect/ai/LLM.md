...
**LLM (Large Language Model)** — это модель машинного обучения, обученная на огромных объёмах текста и способная генерировать, понимать и преобразовывать текст. Ниже — схема того, что происходит при каждом запросе к LLM.
