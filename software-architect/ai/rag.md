...
**RAG** — это архитектурный паттерн в области [[nl-processing]], объединяющий *поиск информации* (retrieval) и *генерацию текста* (generation). Его цель — повысить точность и обоснованность ответов генеративных моделей за счёт привлечения внешних знаний.
