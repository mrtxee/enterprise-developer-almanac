...
- **UI**: [[microfrontend|микрофронтенды]] через федерацию сервисов, например на основе [[react|React]]
- **Backend**
...
- **S3** – [[amazon-s3|объектное хранилище]] для blob
  - [[minio|MinIO]] + AWS Glue (метаданные)
...
- **Metadata** Database хранит данные для поиска информации о доступных форматах и ссылки для просмотра
