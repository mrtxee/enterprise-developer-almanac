...
| ------------------------------- | ------------- | ---------------------------- |
| **DAU** ([[metrics-highload|Daily Active Users]])    | 100 млн       | Активные пользователи в день |
...
5. Рассылка по [[web-socket|веб-сокетам]]: только после успешной записи в базу. Если после ретраев упали — вернуть отправителю отметку о том, что отправить не удалось.
