...
## Data Mart: подмножество хранилища данных

**Data Mart** — это **специализированное подмножество хранилища данных ([[data-warehouse|Data warehouse]])**, ориентированное на **конкретную бизнес-функцию, отдел или аналитическую задачу**.
...
```mermaid
---
title: Структура Data Mart: источники, хранилище и витрины
---
flowchart TB
    subgraph "Источники"
        A[OLTP БД]
...
| **Структура** | Неструктурированные + [[semistructured-data|полуструктурированные]] | Структурированные (схема при записи) | Денормализованные (схема под запросы) |
...
Создаются **зависимые витрины поверх озера данных** с помощью инструментов вроде **dbt** — это даёт скорость, согласованность и гибкость одновременно.
