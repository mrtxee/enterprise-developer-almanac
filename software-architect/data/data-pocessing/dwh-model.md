...
- предусматривают **[[extract-transform-load|ETL-процессы]]** (Extract, Transform, Load) для загрузки и трансформации данных;
...
**DWH (Data Warehouse)** и **[[amazon-s3|S3]] (Amazon S3)** — это два ключевых компонента современных **data-платформ**, но они **разных типов**: один — архитектура, другой — хранилище.
