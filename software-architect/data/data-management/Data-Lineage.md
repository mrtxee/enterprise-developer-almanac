...
```mermaid
---
title: Основные компоненты Data Lineage
---
flowchart TD
...
```mermaid
---
title: Принципы Data Minimization
---
graph TD
...
| **Техническая реализация** | Метаданные, графы зависимостей, [[Data-Catalog|каталоги данных]] | Анонимизация, шифрование, политики хранения |
| **Бизнес-ценность** | Улучшение качества данных, доверие | Снижение рисков, соответствие законам |
| **Когда важно** | При сложных ETL процессах, миграциях | При работе с [[personal-data|PII]], в регулируемых отраслях |
...
## Data Lineage vs Data Flow Diagram

### Основные отличия

```mermaid
---
title: Сравнение Lineage и DFD
---
mindmap
...
```mermaid
---
title: DFD Level 1 — Детализация процессов
---
flowchart TD
...
```mermaid
---
title: Data Lineage — Техническая детализация
---
flowchart TD
...
```mermaid
---
title: Комплексный подход: DFD и Data Lineage
---
flowchart TD
