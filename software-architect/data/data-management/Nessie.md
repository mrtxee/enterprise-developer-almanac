...
```mermaid
---
title: Архитектура Nessie
---
flowchart TB
    subgraph "Хранилище метаданных"
        A[(Nessie Catalog - PostgreSQL / DynamoDB)]
    end
...
#### Слияние изменений после тестирования
...
### Сравнение с встроенными системами версий
...
|----------|--------------|
| **[[ab-testing|A/B-тестирование]] моделей ML** | Ветка `experiment-model-v2` → обучение → сравнение метрик → слияние при успехе |
...
| **Нет поддержки транзакций в реальном времени** | Не заменяет [[OLTP|OLTP]]-базы данных |
