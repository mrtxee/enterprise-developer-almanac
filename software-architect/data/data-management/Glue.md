...
**AWS Glue Data Catalog** — это полностью управляемый сервис метаданных, который выступает в роли **централизованного репозитория** для хранения информации о данных в вашем дата-лейке (преимущественно в [[S3|Amazon S3]]).
