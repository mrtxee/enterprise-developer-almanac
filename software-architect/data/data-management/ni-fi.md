...
> «NiFi — это визуальный конструктор [[extract-transform-load|ETL]]/[[extract-load-transform|ELT]]-процессов, где вы соединяете блоки, как в Lego».
...
| **Более 500 процессоров** | Готовые блоки для работы с файлами, БД, [[kafka|Kafka]], HTTP и др. |
...
| **[[Backpressure|Backpressure]]** | Автоматически останавливает поток при перегрузке |
...
> *"DFD shows the flow. NiFi makes it flow."*

---

## Apache NiFi vs Apache [[airflow|Airflow]]

**Apache NiFi** и **[[airflow|Apache Airflow]]** — это два мощных open-source инструмента для управления потоками данных, но они решают **разные задачи**.
...
```mermaid
---
title: Архитектура NiFi и Airflow
---
graph LR
...
> *"NiFi moves data. Airflow orchestrates work."*
