...
- Трансформации ([[extract-transform-load|ETL]]/ELT, очистка, агрегация)
- Назначения (Data Warehouse, [[software-engineer/terms/abbreviations|BI]], ML-модели)
- Мониторинг, безопасность, качество

**Простыми словами**

> «Как данные попадают из Excel в дашборд — и как убедиться, что они правильные?»
...
> 💬 *«Data is the new oil. Data Flow Management is the pipeline that delivers it.»*
