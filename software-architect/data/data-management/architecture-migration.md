...
Вот чёткое сравнение трёх концепций из разных областей разработки ПО — с акцентом на их **назначение, контекст применения и ключевые различия**.
...
```mermaid
---
title: High-Level Design: структура системы
---
flowchart TD
...
| **Документация** | Диаграммы (C4 model, [[UML|UML]]), описание протоколов, выбор БД/очередей |
...
| **Альтернатива** | [[feature-toggling|Фича-флаги]] (но без архитектурного разделения) |
