...
**BASE** – это одна из **data consistency models**

> **BASE** — это **альтернатива [[acid-consistency|ACID]]**, подходящая для **масштабируемых, отказоустойчивых систем**.
...
- Нет гарантии [[acid-consistency|atomicity]] между регионами;
...
## BASE vs ACID: data consistency models

**BASE vs [[acid-consistency|ACID]]** — это **две противоположные философии**, определяющие, как работает база данных:
