...
Это **база данных временных рядов** (time-series database – [[TSDB|TSDB]]), собранная вокруг мощной модели данных и языка запросов, со простой и надежной архитектурой.
