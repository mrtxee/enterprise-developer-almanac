...
### Election Protocol — обеспечение Partition Tolerance

#### Процесс выборов при сетевом разделении

```mermaid
---
title: Процесс выборов Primary
---
sequenceDiagram
  participant C as Client
  participant P as Primary
...
### Механизмы обеспечения Consistency
...
### Transactions — распределённые транзакции
...
### Partition Tolerance в шардированном кластере

#### Архитектура шардинга

```mermaid
---
title: Архитектура шардинга
---
graph TD
...
### Heartbeat и обнаружение сетевых разделений
...
### Практические сценарии настройки CP
...
```mermaid
---
title: Поведение при сетевом разделении
---
graph LR
...
- **[[acid-consistency|acid-consistency]] Transactions** — распределённые транзакции.
