...
**Принцип нулевой потери данных** предполагает, что данные ни при каких обстоятельствах не должны теряться или повреждаться. В контексте требований [[software-architect/data/data-base/rdbms/ACID|ACID]] эту концепцию можно связать с устойчивостью (Durability).
