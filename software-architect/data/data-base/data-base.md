...
aliases:
  ...
  - Какую базу выбрать
---
## Гайд по выбору базы данных

```mermaid
---
title: Гайд по выбору базы данных
---
graph LR
...
## Durability в распределённых базах
...
| --- | --- | --- | --- | --- | --- | --- |
| [[PostgreSQL|PostgreSQL]] | Да | Да (WAL) | Да | Синхронная/асинхронная | Нет | Нет |
| [[Cassandra|Cassandra]] | Lightweight Transactions | Нет | Да (на уровне хранения) | Асинхронная | Да (через конфликты) | Да |
| [[mongo-db|MongoDB]] | На уровне документа | Нет | Нет | Асинхронная | Да (через поля версий) | Да |
