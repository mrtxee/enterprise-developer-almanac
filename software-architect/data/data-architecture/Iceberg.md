...
**Apache Iceberg** — это **открытый формат таблиц для аналитических систем**, предназначенный для работы с **масштабными данными в объектных хранилищах** (S3, GCS, ADLS и др.). Он решает ключевые проблемы традиционных «озер данных» (data lakes), превращая их в **lakehouse** — гибрид озера и склада данных.
