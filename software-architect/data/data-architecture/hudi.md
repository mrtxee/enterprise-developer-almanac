...
- **[[acid-consistency|acid-consistency]]-транзакций**

> **Ключевая идея**:
> *«Data Lake + транзакции = управляемое озеро данных»*
> Hudi добавляет «мозги» к объектному хранилищу ([[amazon-s3|S3]], ADLS, GCS), позволяя обрабатывать данные как в базе данных, но с масштабируемостью озера.
