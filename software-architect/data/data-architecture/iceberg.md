...
**Apache Iceberg** — это **открытый формат таблиц для аналитических систем**, предназначенный для работы с **масштабными данными в объектных хранилищах** ([[amazon-s3|S3]], GCS, ADLS и др.). Он решает ключевые проблемы традиционных «озер данных» ([[data-lake|Data lakes]]), превращая их в **lakehouse** — гибрид озера и склада данных.
...
**Проблемы**
1. **Нет [[acid-consistency|acid-consistency]]-транзакций** — конкурентные записи ломают данные.
