...
- **Снижение рисков несоответствия регуляторным требованиям** ([[general-data-protection-regulation|GDPR]], HIPAA и др.).
...
- Сама таблица может быть в [[amazon-s3|S3]], но её описание — в PostgreSQL.
...
**Что это**
- Оригинальный и самый популярный каталог метаданных, созданный для [[hive-ql|Apache Hive]].
- Де-факто стандарт в экосистеме [[map-reduce|Hadoop]].
