...
**Delta Lake**, **Apache Hudi** и **Apache Iceberg** — это три ведущих **open-table format** (формата таблиц), превращающих объектные хранилища ([[amazon-s3|S3]], ADLS, GCS) в надёжные **lakehouse**. Все они решают схожие задачи, но с разными подходами.
