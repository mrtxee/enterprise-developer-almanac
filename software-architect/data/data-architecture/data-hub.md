...
aliases:
  ...
  - Metadata platform
  - Каталог данных
  - Платформа управления метаданными
---

**DataHub** — это **современная платформа управления метаданными (metadata platform)** с открытым исходным кодом, разработанная компанией **LinkedIn** и выпущенная как open-source проект в 2020 году.
...
- Озера: [[amazon-s3|S3]], ADLS с [[iceberg|Iceberg]]/Delta
