...
aliases:
  ...
  - SASL
  - Schema
  - Лёгкий протокол доступа к каталогам
---
...
**LDAPS (LDAP over SSL/TLS)** — защищённая версия протокола LDAP, которая использует SSL/TLS для шифрования данных при передаче по сети.

**Простыми словами**

> Это **телефонная книга для сетей**: можно быстро найти, кто такой «Иван Петров», в какой он группе, какой у него email.
...
```mermaid
---
title: Упрощённая структура LDAP
---
graph LR
    A[dc=example,dc=com]:::root
    B[ou=People]:::ou
...
> 💬 *«LDAP is not magic. It's a hierarchical phone book for your network.»*
