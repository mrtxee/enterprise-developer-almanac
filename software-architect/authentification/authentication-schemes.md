...
- ❌ **Stateful (с состоянием).** Сервер должен хранить сессии (проблема при горизонтальном масштабировании, нужен общий Redis). Плохо подходит для мобильных приложений и кросс-доменных запросов ([[cyber-threats-2|CORS]]).
