...
### Сценарии использования Keycloak
...
### Keycloak и микросервисы

```mermaid
---
title: Keycloak и микросервисы
---
graph TD
...
> *"With Keycloak, you can build your own Google-style authentication system."*

---

### Итог: выбор по ситуации
...
- Официальная документация — keycloak.org
