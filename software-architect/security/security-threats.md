...
2. **Аутентификация**
   - Факторы аутентификации:
     ...
     - **Possession** — владение, например [[OTP]]
...
3. **Авторизация**
   ...
   - Принципы управления методами
     ...
     - Принцип доверия с осторожностью ([[zero-trust]]) — никто не считается безопасным по умолчанию, все пользователи и устройства постоянно проверяются и подтверждаются
...
[distributed-information-systems](distributed-information-systems.md) представляют вызов для обеспечения целостности данных по причинам, основанным на [[CAP-theorem|CAP-теореме]].

Типовые решения:

- переход на Eventual Consistency модель
  - [[BASE]] — гарантии для распределённой информационной системы
...
- Обнаружение и предотвращение утечек данных при помощи [[data-loss-prevention]]-системы
- Защита ключей безопасности при помощи [[hardware-security-module]]/[[key-management-service]] систем
