...
aliases:
  ...
  - Хеш
---
Для систем с высокими требованиями к [[cia-triad|целостности]] и прозрачности данных может быть полезен подход на основе блокчейна. Например, к таким системам относятся сервисы финтеха и здравоохранения.

**Blockchain (блокчейн)** — это технология, которая позволяет создавать **децентрализованные, неизменяемые и доверенные системы** без центрального органа.

В использовании блокчейна есть два плюса:
...
```plain
**Блок #100**
- Транзакции: Alice → Bob: 1 BTC, Carol → Dave: 2
- Предыдущий хеш: `a3b7c8...`
- Текущий хеш: `d9e2f5...`
...
```mermaid
---
title: Отправка транзакции в Bitcoin
---
sequenceDiagram
    participant Alice
    participant Bob
...
```mermaid
---
title: Архитектура блокчейн-сети
---
graph LR
