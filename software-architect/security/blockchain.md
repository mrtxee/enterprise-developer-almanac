...
aliases:
  ...
  - Хеш
---
Для систем с высокими требованиями к целостности и прозрачности данных может быть полезен подход на основе блокчейна. Например, к таким системам относятся сервисы финтеха и здравоохранения.
