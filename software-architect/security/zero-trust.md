...
- Удалёнка (не важно, где находится пользователь)
...
```mermaid
---
title: Zero Trust + Adaptive Auth
---
sequenceDiagram
    participant User
...
> ✅ **Adaptive Auth** — решает: _«Можно ли войти?»_
> ✅ **Zero Trust** — решает: _«Что можно делать после входа?»_
...
Когда хакеры используют **ваши же учётные данные**, нужно **проверять не только пароль — а всё**.
