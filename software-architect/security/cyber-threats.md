...
aliases:
  ...
  - атаки на мобильные и IoT-устройства
  - атаки на подлинность
  - атаки на приложения и API
  - атаки на ресурсы
...
```mermaid
---
title: Схема классификации киберугроз
---
graph BT
...
### Атаки на подлинность (Authenticity)
...
> Ключ утёк в GitHub, логах, Slack
