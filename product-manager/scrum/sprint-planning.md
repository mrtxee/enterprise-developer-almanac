...
| **Sprint Review**        | Демонстрация результата [[change-management|стейкхолдерам]] | Обратная связь, обновлённый Product Backlog |
...
**Backlog Refinement** — регулярная активность, когда команда вместе с Product Owner «причёсывает» бэклог: декомпозирует крупные задачи, уточняет [[change-management|требования]], оценивает трудоёмкость, выявляет риски и зависимости. Цель — чтобы к моменту Sprint Planning задачи в верхней части бэклога были достаточно ясными для включения в спринт без долгих обсуждений.
...
**Пример Acceptance Criteria для [[microservice|микросервиса]]:**
...
- ✅ Код в репозитории и прошёл CI: сборка успешна, нет критических ошибок в Sonar/[[software-qauality-assessment|Checkstyle]]/SpotBugs.
