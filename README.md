...
│   │   │   ├── data-base.md
│   │   │   ├── distributed-information-systems.md
│   │   │   ├── graph-database.md
│   │   │   ├── graph-db.md
│   │   │   ├── mongo
│   │   │   │   ├── mongo-db.md
...
│   │   ├── system-design-const.md
│   │   ├── system-design-interview-book.md
...
│       ├── development-life-cycle.md
│       ├── ownership-cost.md
│       ├── software-composition-analysis.md
│       ├── Tableau.md
│       ├── technical-debt.md
...
│   │   ├── geometry.md
│   │   ├── multithreading.md
│   │   └── unit-testing-principals.md
│   ├── java
│   │   ├── java-class-library
│   │   │   ├── functional-interface-composition.md
│   │   │   ├── functional-interface.md
│   │   │   ├── Future.md
│   │   │   ├── Instant.md
│   │   │   ├── java-collection-framework.md
│   │   │   ├── java-concurrency-utilities.md
...
│   │   │   ├── cache-line.md
│   │   │   ├── happens-before.md
│   │   │   ├── java-microbenchmark-harness.md
│   │   │   ├── jmm-deeper.md
│   │   │   ├── jmm-gc.md
│   │   │   ├── jmm.md
│   │   │   ├── jmm-reordering.md
...
│   │       ├── Input-stream.md
│   │       ├── Java-faq.md
│   │       ├── java-http-client-pick.md
│   │       ├── java-monetary-type-jsr354.md
│   │       ├── java-monetary-type.md
│   │       ├── java-passwords.md
│   │       ├── java-read-patterns.md
│   │       ├── java-tx.md
│   │       ├── javax-vs-jakarta.md
│   │       ├── jpa-modifying.md
│   │       ├── junit.md
...
│   │       │   ├── spring.md
│   │       │   ├── Spring-paths.md
│   │       │   ├── spring-post-processor.md
│   │       │   ├── spring-response-entity.md
│   │       │   ├── spring-rest-client.md
│   │       │   ├── Spring-retry.md
│   │       │   ├── Spring-Scheduled.md
│   │       │   ├── Spring-Security.md
│   │       │   ├── spring-validator-adapter.md
│   │       │   ├── Spring-vars.md
│   │       │   └── spring-web-mvc-configurer.md
│   │       ├── swagger.md
│   │       └── thread-safe-init.md
│   ├── notation
│   │   ├── activity-diagram.md
│   │   ├── architecture-design-log.md
│   │   ├── BCM.md
│   │   ├── BPMN.md
│   │   ├── c4.md
...
│   │   ├── Hub‑and‑Spoke.md
│   │   ├── microservice
│   │   │   ├── asynchronous-integration.md
│   │   │   ├── build-time-compositon.md
...
│   │   ├── org-oasis.md
│   │   ├── problem-details.md
│   │   ├── quantities-and-units.md
│   │   ├── software-life-cycle.md
│   │   ├── syslog-protocol.md
│   │   ├── url.md
│   │   └── uuid.md
│   ├── tech
...
│   │   │   ├── gateway-api.md
│   │   │   ├── helm.md
│   │   │   ├── k8s-cluster-defaults.md
│   │   │   ├── k8s-cluster-setup.md
│   │   │   ├── k8s-entity-hierarchy.md
│   │   │   ├── k8s-init-container.md
│   │   │   ├── k8s-rbac.md
│   │   │   ├── k8s-replicaset.md
│   │   │   ├── k8s-request-limit.md
│   │   │   ├── k8s-request-vs-query.md
│   │   │   ├── kubeconfig.md
│   │   │   ├── kubectl.md
│   │   │   ├── kubelet.md
...
│   │   │   │   ├── boot-chains.md
│   │   │   │   ├── bootloader.md
│   │   │   │   ├── clipboard-manager.md
│   │   │   │   ├── core-utils.md
│   │   │   │   ├── cosmic-desktop.md
│   │   │   │   ├── dconf.md
│   │   │   │   ├── find.md
│   │   │   │   ├── fs-cleanup.md
│   │   │   │   ├── gnome-extension-upver.md
│   │   │   │   ├── gparted.md
│   │   │   │   ├── hibernation.md
│   │   │   │   ├── install-niri.md
│   │   │   │   ├── install-tar-xz.md
│   │   │   │   ├── install-with-file.md
│   │   │   │   ├── intel-npu-driver.md
│   │   │   │   ├── journalctl.md
│   │   │   │   ├── llama.cpp.md
│   │   │   │   ├── mount-everything.md
...
│   │   │   │   ├── pacman.md
│   │   │   │   ├── pacman-reflector.md
│   │   │   │   ├── pacman-yay-faltpak.md
│   │   │   │   ├── plymouth-theme.md
│   │   │   │   ├── printer-setup.md
│   │   │   │   ├── processes.md
│   │   │   │   ├── swap-partition.md
│   │   │   │   └── uefi-loader-setup.md
│   │   │   ├── bios-uefi.md
│   │   │   ├── bootloader.md
│   │   │   ├── chown.md
...
│   │   │   ├── linux-distros.md
│   │   │   ├── linux-distros-roadmap.md
│   │   │   ├── linux-folders.md
│   │   │   ├── linux-kernel.md
│   │   │   ├── linux-load-phases.md
│   │   │   ├── linux-packages.md
...
│   │   ├── ycloud
│   │   │   ├── yandex-cloud-cli.md
│   │   │   ├── yandex-container-registry.md
│   │   │   ├── yandex-managed-kubernetes.md
│   │   │   ├── yandex-message-queue.md
│   │   │   ├── yandex-serverless-integrations.md
│   │   │   ├── ycloud-economics.md
│   │   │   ├── ycloud-monitoring.md
│   │   │   └── ycloud-virtualization.md
│   │   └── Zippy.md
│   └── terms
│       ├── abbreviations.md
│       ├── boilerplate.md
