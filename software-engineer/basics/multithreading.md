...
- Основной поток может создавать другие потоки с помощью [[functional-interface|функциональных интерфейсов]] `Callable` и `Runnable`.

#### class Thread

`implements Runnable`, `java.lang.Thread`

Класс [[java-thread|java-thread]] служит для создания потоков и работы с ними.
