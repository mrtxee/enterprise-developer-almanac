...
**Формальная логика** изучает **формы мышления** (понятия, суждения, умозаключения) и их **законы**. В информатике она лежит в основе [[algorithm|алгоритмов]], [[data-base|баз данных]] и верификации программ.
...
**[[cartesian-product|Декартово произведение]]** множеств $A$ и $B$ — множество всех упорядоченных пар:
...
Формальная логика — фундамент [[algorithm|алгоритмов]], типов данных и [[data-base|баз данных]]: проверка условий, булева алгебра, теория отношений.
