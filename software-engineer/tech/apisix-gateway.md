...
```mermaid
---
title: Основные возможности APISIX Gateway
---
graph LR
...
- ✅ Динамическую маршрутизацию и [[service-discovery|service discovery]]
- ✅ Балансировку нагрузки с различными алгоритмами
- ✅ Аутентификацию и авторизацию ([[JWT|JWT]], OAuth2, Key Auth)
...
- ✅ [[RPC|gRPC]], [[web-socket|WebSocket]], GraphQL поддержку
- ✅ [[serverless|Serverless]] интеграции
- ✅ Custom plugins на Lua

**Преимущества APISIX:**

- ✅ Высокая производительность (меньшая задержка, чем у [[nginx|Nginx]])
- ✅ Динамическая конфигурация без перезагрузки
- ✅ Богатая экосистема плагинов
- ✅ Cloud-native архитектура
- ✅ Расширяемость через Lua-плагины

APISIX идеально подходит для современных [[microservice|микросервисных архитектур]] и API-ориентированных приложений.
