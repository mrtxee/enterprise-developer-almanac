...
AMQP позиционировался как «HTTP для обмена сообщениями» — единый стандарт, дополняющий паттерны вроде [[microservice|микросервисов]].
...
| **Транспорт** | [[tcp-udp|TCP]] | TCP (лёгкий) | TCP |
...
| **Использование** | Сервисы, [[microservice|микросервисы]], микросервисные интеграции | IoT, датчики, телефония | Логи, аналитика, event streaming |
