...
- `[[cat|cat]]` — прочитать содержимое файла.
...
Связанная тема: [[vim|vim]].

### SSH

SSH — [[ssh-scp-sftp|Secure Shell]] — протокол удалённого управления компьютером с операционной системой Linux.
...
**[[java-cacerts|cacerts]]** — файл с хранилищем сертификатов для доступа к репозиториям.
