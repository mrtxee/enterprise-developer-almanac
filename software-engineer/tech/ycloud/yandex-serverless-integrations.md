...
**Yandex Object Storage** — масштабируемое облачное [[amazon-s3|объектное хранилище]] данных, совместимое с Amazon S3 API. У Object Storage есть ряд преимуществ перед обычным сервером, на который можно писать данные в произвольную папку.
