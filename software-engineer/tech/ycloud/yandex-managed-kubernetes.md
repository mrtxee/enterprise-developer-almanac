...
Управление контейнерами: отслеживание работоспособности и перезапуск при сбоях, обновление, развёртывание, масштабирование, остановка. Такое управление называется **оркестрацией**.
...
- Для хранения Docker-образов подов кластера используется Yandex Container Registry.
