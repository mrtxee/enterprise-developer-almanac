...
* Самый молодый, при этом гибкий и лаконичный формат, основанный на C-подобном синтаксисе
...
* предшественник KDL
	* хуже тем, что:
		...
		* нет возможности в 1 строке объявить комментари для многострочного блока
