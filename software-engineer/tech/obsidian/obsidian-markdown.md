...
KD-дерево — это **бинарное дерево**, которое рекурсивно разбивает пространство по **[[geometry#Гиперплоскость|гиперплоскостям]]** (например, вертикальным и горизонтальным линиям для 2D).
