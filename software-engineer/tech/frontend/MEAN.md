...
**MEAN** в контексте хранения данных — это не статистическое «среднее значение», а **стек технологий** для веб-разработки.

## Что такое MEAN стек

Диаграмма стека MEAN:

```mermaid
---
title: Состав MEAN стека
---
graph TD
    A[MEAN Stack] --> M[MongoDB]
    A --> E[Express.js]
    A --> F[Angular/AngularJS]
    A --> N[Node.js]

    M --> M1[База данных]
    E --> E1[Backend Framework]
    F --> F1[Frontend Framework]
...
**Характеристики [[mongo-db|MongoDB]]:**

- **JSON-подобные документы** — естественное представление данных.
- **Горизонтальное масштабирование** — [[mongo-db|шардирование]].
...
```mermaid
---
title: Архитектура MEAN приложения
---
graph TD
...
| ------ | ---- | ---- | ---- |
| **Язык** | [[javascript|JavaScript]] | PHP | JavaScript |
| **База данных** | [[mongo-db|MongoDB]] | MySQL | MongoDB |
...
- **Команды с экспертизой в [[javascript|JavaScript]]**.
...
**Итог:** MEAN в контексте хранения данных — это стек из:
