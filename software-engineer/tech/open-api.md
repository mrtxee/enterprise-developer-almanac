...
## Синтаксис спецификации OpenAPI

OpenAPI Specification (OAS) — стандарт описания REST-API в формате **[[config-formats|JSON]]** или **[[config-formats|YAML]]**. Позволяет автоматически генерировать документацию, клиентский код и тесты.
...
Примеры приведены для синтаксиса OpenAPI 3.0.
...
- Валидация контрактов API в [[CI-CD|CI/CD]].
