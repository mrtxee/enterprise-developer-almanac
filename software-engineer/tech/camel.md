...
aliases:
  ...
  - ESB
  - iPaaS
  - Корпоративные интеграционные паттерны
---

## Apache Camel

### Определение Apache Camel
...
> **Простыми словами:** *«Apache Camel — это универсальный адаптер для ИТ-систем. Как переходник для разных розеток, но для программ.»*

### Категория ИТ-инструментов
...
```mermaid
---
title: Компонентная модель Apache Camel
---
flowchart LR
    A[HTTP] --> Camel
    B[FTP] --> Camel
...
**Пример: простая маршрутизация (Java DSL)**
...
**Пример: интеграция с Kafka и базой данных**
...
Camel часто используется вместе с Kafka: Kafka как транспорт + Camel как процессор сообщений.
...
Serverless Camel для Kubernetes:
...
Запуск маршрутов без компиляции:
...
**Apache Camel остаётся одним из самых мощных и гибких инструментов интеграции в экосистеме Java.**
