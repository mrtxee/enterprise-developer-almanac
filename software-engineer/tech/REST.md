...
| Построить высокопроизводительный микросервис | [[RPC|gRPC]] — лучше, чем REST, для внутренней коммуникации |
...
| **Документация важнее** | Компании предпочитают Swagger/[[open-api|open-api]] — человек читает, а не клиент ходит по ссылкам |
...
**Форматы**
- **HAL** — самый распространённый, поддерживается [[spring|Spring]], ASP.NET, Node.js
