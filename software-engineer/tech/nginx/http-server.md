...
* **Маршрутизация:** Перенаправление запросов на нужные внутренние сервисы или балансировка нагрузки (функция Reverse Proxy).

**Популярные примеры**

* **Классические веб-серверы:** Nginx, Apache, Caddy.
...
1. **Классические веб-серверы:** Занимаются обработкой HTTP-запросов, отдачей статических файлов, SSL-терминацией и проксированием (Nginx, Apache, Caddy).
...
### 1. Nginx (Engine-X)
* **Тип:** Классический веб-сервер / Reverse Proxy / Балансировщик.
* **Архитектура:** Асинхронная, событийно-ориентированная.
* **Для чего лучше всего:** Раздача статики, проксирование запросов к бэкенду, балансировка нагрузки, защита от DDoS.
...
* **Для чего лучше всего:** Корпоративные среды на базе Windows Server, приложения на ASP.NET, C#, интеграция с Active Directory.
