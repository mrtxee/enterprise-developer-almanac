...
GNOME по умолчанию тесно интегрирован с NetworkManager. Если у вас одновременно установлены и запущены другие менеджеры сети (например, `[[iwctl|iwd]]` или `dhcpcd`), они могут конфликтовать с NetworkManager и мешать его корректной работе.
