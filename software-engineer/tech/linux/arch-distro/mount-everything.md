...
**Монтирование WebDAV (davfs2)**

```bash
# sudo pacman -S davfs2
# echo "https://webdav.cloud.mail.ru login password" | sudo tee -a /etc/davfs2/secrets
