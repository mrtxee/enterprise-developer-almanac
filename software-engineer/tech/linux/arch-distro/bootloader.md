...
### Переход с [[boot-chains|boot-chains]] на GRUB
...
**Когда редактируют:** при настройке шифрования диска, [[gparted|LVM]], RAID, добавлении поддержки нестандартного оборудования.
...
**Назначение:** главный конфигурационный файл загрузчика GRUB в дистрибутивах на базе [[linux-distros|Debian]]/Arch.
