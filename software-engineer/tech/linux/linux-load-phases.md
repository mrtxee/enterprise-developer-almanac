...
Экран — это не одно место, а переключатель между несколькими независимыми каналами связи с системой, которые называются TTY. Вот как они распределены в GNOME по умолчанию:
