...
Один коммутатор → три VLAN:

- VLAN 10: HR
- VLAN 20: IT
- VLAN 30: Guests

Даже если все устройства подключены к одному switch, они **не видят друг друга**, если не сконфигурирован маршрутизатор.
...
```mermaid
---
title: Трафик VLAN через коммутатор
---
graph TD
...
Каждый порт на switch может быть:
