...
| Ссылки (доступ к сети) | Ethernet, Wi-Fi, [[ppp|PPP]] |
...
| Используется в | Веб (HTTP/HTTPS), почта ([[mime|SMTP]]), файлы (FTP), SSH |
...
| Используется в | Видеозвонки (Zoom), стриминг (YouTube Live), онлайн-игры, [[dns|DNS]], VoIP |
...
| --- | --- | --- | --- |
| Что это? | Протокол транспортного уровня (4 уровень [[open-systems-interconnection|open-systems-interconnection]]) | Протокол транспортного уровня | Семейство протоколов (модель сети) |
