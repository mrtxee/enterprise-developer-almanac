...
- база данных (PostgreSQL, [[mongo-db|mongo-db]])
...
Это аналог [[UML|UML]] Component Diagram, но проще и понятнее.
...
| **[[plant-uml|PlantUML]]** | Код-ориентированный: пишется код → получается диаграмма |
...
[[plant-uml|plant-uml]] можно использовать для создания диаграмм на каждом уровне C4. Это автоматизирует процесс документирования и интегрирует его с системой контроля версий.
