...
[[plant-uml]] можно использовать для создания диаграмм на каждом уровне C4. Это автоматизирует процесс документирования и интегрирует его с системой контроля версий.
