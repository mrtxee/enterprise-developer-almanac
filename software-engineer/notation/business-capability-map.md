...
Используются **стандартные модели** (например, **[[TOGAF|TOGAF]]**, **[[TOGAF|ArchiMate]]**, **APQC**) — они содержат готовые шаблоны для разных отраслей.
...
- **Связь с [[business-process-model-notation|BPMN]]:** какие процессы поддерживают каждую возможность?
