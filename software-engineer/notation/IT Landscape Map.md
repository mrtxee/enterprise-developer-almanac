...
> *«CRM (REST API v2) → ERP (SOAP через мост) — передаётся заказ, клиент, платеж»*
...
> *«CRM поддерживает способность “Управление отношениями с клиентами”»*
> *«Kafka поддерживает способность “Аналитика событий в реальном времени”»*
...
> *«IT Landscape — это не диаграмма. Это ваша память.
> Без неё — вы каждый раз начинаете с нуля.
> С ней — вы знаете, откуда пришли, и куда идти.»*
