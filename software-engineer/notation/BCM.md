...
- **Ничего про IT!** — нет упоминания о системах (Core Banking, [[software-engineer/standard/КИС|crm]], BI и т.д.).
...
> *«Что мы хотим достичь через 3–5 лет?»*
...
> *«Что нам нужно уметь делать, чтобы достичь этой цели?»*
...
> *«А зачем нам это?»*
> *«А кто это решает?»*
> *«А как это связано с нашей стратегией?»*

> 💬 **BCM — это ваш инструмент, чтобы ответить:
> *«Всё это — потому что мы хотим стать лучше в этом.»***
