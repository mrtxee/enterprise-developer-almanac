...
- **Анализ требований** — [[use-case|Use Case]] и диаграммы деятельности.
...
- Диаграмма последовательности ([[sequence-diagram|Sequence Diagram]])
- Диаграмма деятельности ([[activity-diagram|Activity Diagram]])
