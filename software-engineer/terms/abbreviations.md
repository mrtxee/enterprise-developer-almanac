...
В разработке программного обеспечения и инженерии используется огромное количество аббревиатур. Ниже — наиболее популярные, сгруппированные по категориям.
...
| **K8s**       | Kubernetes (K-8-букв-...s)                      | Система оркестрации контейнеров    |
...
| **SCA**      | Software Composition Analysis            | Анализ состава зависимостей и лицензий        |
...
- **TAM (Telecom Architecture Model)** — модель архитектуры для телеком-индустрии.
- **BIAN (Banking Industry Architecture Network)** — архитектура для банковской индустрии.
- **АБС (Автоматизированная банковская система)**.
- **PLM (Product Lifecycle Management)** — система управления жизненным циклом продукта.
  - Teamcenter.
- **PDM (Product Data Management)** — система управления данными об изделии. Позволяет работать с автоматизированным проектированием для сбора информации о версиях узлов изделия и вести разработку изделия полностью в цифровом виде.
- **MES (Manufacturing Execution System)** — системы для управления самим процессом производства на заводах и фабриках.
- **SCADA (Supervisory Control and Data Acquisition)** — системы для сбора данных с различных устройств в процессе производства и управления линиями, станками с ЧПУ и так далее.
