...
Возвращает хэшкод объекта, который нужен прежде всего при [[hash-function|хешировании]]. Разные реализации [[jvm|JVM]] предлагают разные методы генерации хэшкода. Часто он бывает привязан к адресу объекта в памяти.
