...
---
## ⚙️ `System.getenv()` vs `System.getProperty()`
...
## 🎯 Выбор между getenv и getProperty
...
```mermaid
---
title: Матрица выбора System.getenv() и System.getProperty()
---
flowchart LR
...
## Загрузка из файлов `app.env` и `app.vmoption`
