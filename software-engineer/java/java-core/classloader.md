...
- загружает все [[jdk-jls-jni|JAR]] из CLASSPATH;
...
2. **Platform ClassLoader**
   - загружает платформозависимые расширения из модульной системы [[jdk-jls-jni|JDK]];
...
> [!info] CLASSPATH
> Параметр в [[jvm|виртуальной машине Java]] или компиляторе Java, который определяет расположение пользовательских классов и пакетов. Параметр может быть задан либо в командной строке, либо через переменную среды.
