...
`java.util.logging.Logger` считается устаревшим. Принято использовать [[lombok|Lombok]] SLF4J, когда нет ограничений на подключение внешних пакетов, либо Logback.
