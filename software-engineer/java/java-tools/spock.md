...
**Specification** — базовый класс для всех тестов в **Spock Framework** (альтернатива JUnit, написанная на Groovy). Он предоставляет [[behavior-driven-development]]-стиль написания тестов с богатой DSL и выразительным синтаксисом.
