...
**Включение управления транзакциями:**
...
### Транзакции в контроллере

**Аннотация на уровне метода контроллера**
...
**Аннотация на уровне класса контроллера**
...
#### Настройка rollbackFor и noRollbackFor
