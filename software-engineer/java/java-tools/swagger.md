...
Swagger предоставляет спецификацию для документирования [[REST|REST]] API, которая называется [[REST#OpenAPI|OpenAPI Specification]] (**OAS**). Эта спецификация дает четкий и лаконичный способ описания эндпойнтов, их параметров, моделей запросов и ответов и других аспектов API.
