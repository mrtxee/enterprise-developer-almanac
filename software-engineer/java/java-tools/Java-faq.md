...
2. Изменить видимость метода через [[reflection-api|рефлексию]].
...
См. [[layered-architecture|layered-architecture]].
...
Термин придуман Мартином Фаулером #👨 с сотоварищами в пику [[javax-vs-jakarta|EJB]] (Enterprise JavaBeans): отсутствие звучного термина для простых объектов приводило к тому, что молодые Java-программисты пренебрежительно к ним относились, считая, что только EJB «спасут мир».
...
- [[java-core#Примитивные типы|java-core]]
