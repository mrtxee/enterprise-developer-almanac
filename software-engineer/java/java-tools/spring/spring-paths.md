...
Для современного Java-приложения (особенно с использованием [[spring|Spring Boot]]) оптимальная структура пакетов выглядит так:
...
**[[spring|Spring Boot]] (официальные примеры)**
