...
**Spring Security** — это enterprise-фреймворк для **аутентификации** (кто пользователь) и **авторизации** (что ему разрешено) в Java/Spring-приложениях. Это не просто библиотека, а целая архитектура фильтров, менеджеров и контекстов, которая глубоко интегрирована в Spring MVC, WebFlux и Boot.
...
```mermaid
---
title: Цепочка фильтров Spring Security
---
flowchart TB
...
## Современная настройка (Spring Security 6+ / Spring Boot 3)
