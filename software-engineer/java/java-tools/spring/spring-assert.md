...
**`org.springframework.util.Assert`** — это утилитный класс в **[[spring|Spring Framework]]**, предназначенный для **валидации аргументов и состояний** в коде. Он используется для проверки условий и выбрасывания исключений, если условие не выполнено.
...
| ❌ В **бизнес-логике** для валидации данных пользователя | Используйте **[[spring-validator-adapter|Bean Validation]]** (`@NotNull`, `@Valid`) |
