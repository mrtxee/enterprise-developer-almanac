...
При использовании Spring Boot с Spring MVC фреймворк автоматически настраивает:
...
Иногда нужно добавить свою логику:
...
## WebMvcConfigurer и WebMvcConfigurationSupport
...
> ⚠️ Не расширяйте `WebMvcConfigurationSupport`, если используете Spring Boot — это отключит автоконфигурацию!
