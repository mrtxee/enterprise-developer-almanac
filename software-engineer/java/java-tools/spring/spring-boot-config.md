...
aliases:
  ...
  - стандартные атрибуты application.yaml
  - стандартные свойства Spring Boot
---

## Атрибуты application.yaml в Spring Boot
...
1. Некоторые свойства появились в определённых версиях Spring Boot. Указанные свойства актуальны для Spring Boot 3.4.x.
2. Используйте синтаксис `${}` для подстановки значений из переменных окружения.
3. Разные профили могут переопределять значения:
...
4. Основные источники документации:
