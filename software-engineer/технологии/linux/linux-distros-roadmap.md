...
---
flowchart LR
    Start(["🎯 Какой ОС/дистрибутив выбрать?"]) --> Q1{"Максимальная стабильность<br>или самое свежее ПО ?"}
    Q1 -- Стабильность,<br>BSD --> BSD_Q["Приоритет<br>производительность<br>или безопасность?"]
    BSD_Q -- Максимальная<br>Производительность --> FreeBSD["🐉 FreeBSD"]
    BSD_Q -- Максимальная<br>безопасность --> OpenBSD["🐡 OpenBSD"]
    Q1 -- Свежее ПО,<br>Linux --> Q2{"Какая<br>основная задача?"}
