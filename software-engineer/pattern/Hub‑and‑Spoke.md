...
Hub‑and‑Spoke — паттерн, применяемый при интеграционном тестировании. Это архитектурный паттерн или термин из области тестирования производительности и интеграционных тестов (хотя сам термин не является стандартным в JUnit или Mockito).
