...
|-----------|----------|--------------------|
| **[[TOGAF|TOGAF]]** | Самый популярный стандарт (The Open Group) — методология создания EA | Крупные компании, регулируемые отрасли (банки, госструктуры) |
...
| **[[COBIT|COBIT]]** | Управление ИТ-услугами, контроль, соответствие | Для аудита, управления рисками, SLA — часто используется вместе с TOGAF |
| **[[business-process-model-notation\|BPMN]] / [[c4-diagram\|C4]] / UML** | Инструменты для визуализации процессов и систем | Для описания бизнес-процессов, IT-ландшафта, компонентов |
...
| Стартап с 5 разработчиками | **Не нужно** — используйте [[agile|Agile]] + DevOps |
| Используются [[kubernetes|Kubernetes]], [[microservice|microservice]], [[CI-CD\|CI/CD]] | **Обязательно** — без EA не управлять сложностью |
...
4. **Создали Technology Architecture:** перешли на AWS + Kubernetes; внедрили [[api-gateway|API Gateway]] и [[kafka|Kafka]].
