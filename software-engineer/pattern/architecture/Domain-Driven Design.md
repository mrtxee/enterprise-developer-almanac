...
2. **Моделирование:** Использование диаграмм, карточек, досок (как цифровых, так и физических), где все рисуют и описывают процессы _вместе_.
...
4. **Документирование:** Ведение глоссария (в вики, в документации к коду), где записываются определения терминов. Но важно, чтобы этот глоссарий _следовал_ за языком, а не диктовал его.
