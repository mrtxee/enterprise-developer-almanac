...
| ✅ Вы используете **[[kubernetes]], [[microservice]], [[CI-CD\|CI/CD]]** | ✅ **Обязательно** — без EA вы не сможете управлять сложностью   |
...
> *"Бизнес не интересует, какой у вас сервер. Он интересует, почему вы не можете дать ему отчёт о продажах за вчера.
> EA — это то, что превращает 'технический хаос' в 'бизнес-ответ'."*
...
> *«А почему мы не знали, что это зависит от этого?»*
> *«А почему это так дорого?»*
