...
Сравнение поведенческих паттернов GoF Command и Chain of Responsibility: диаграммы классов, живые примеры на Java, сочетание паттернов и правила выбора.
...
```mermaid
---
title: Command Pattern — диаграмма классов
---
classDiagram
    class Command {
        <<interface>>
...
```mermaid
---
title: Chain of Responsibility Pattern — диаграмма классов
---
classDiagram
    class Handler {
        <<abstract>>
...
| Нужно ставить задачи в очередь | ➤ Command |
| Неизвестно заранее, кто обработает запрос | ➤ Chain of Responsibility |
| Нужно логировать все операции | ➤ Command |
| Обработка зависит от уровня полномочий | ➤ Chain of Responsibility |
| Нужно динамически менять обработчики | ➤ Chain of Responsibility |
...
Выбор зависит от задачи; при сложных сценариях паттерны комбинируются.
