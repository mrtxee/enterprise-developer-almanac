...
Паттерны GoF решают часто встречающиеся проблемы проектирования и делятся на три категории:
...
Книга **«Design [[pattern]]s: Elements of Reusable Object-Oriented Software»** (1994) #📘, написанная «Бандой четырёх» (GoF — Gamma #👨, Helm #👨, Johnson #👨, Vlissides #👨), — фундаментальная работа, определившая 23 классических паттерна проектирования.
