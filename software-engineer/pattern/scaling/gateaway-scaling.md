...
```mermaid
---
title: Отказоустойчивый прокси-шлюз
---
flowchart LR
...
## Подходы к отказоустойчивому масштабированию
...
## Обязательные требования к горизонтальному масштабированию
...
- При остановке узла шлюз должен:
  ...
  - Дождаться завершения активных запросов (таймаут 10–30 сек)
  - Только после этого завершать процесс
...
## Пошаговая реализация (Kubernetes + Cloud LB)
