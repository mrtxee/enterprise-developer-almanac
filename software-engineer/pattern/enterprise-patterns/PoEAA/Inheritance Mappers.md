...
Паттерн **Inheritance Mappers** (Мапперы наследования) из книги Мартина Фаулера [#👨](app://obsidian.md/index.html#%F0%9F%91%A8) *Patterns of Enterprise Application Architecture* [#📘](app://obsidian.md/index.html#%F0%9F%93%98) решает фундаментальную проблему: **объектно-реляционное несоответствие (Object-Relational Impedance Mismatch)**.
