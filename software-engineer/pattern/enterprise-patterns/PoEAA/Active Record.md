...
В книге Мартина Фаулера [#👨](app://obsidian.md/index.html#%F0%9F%91%A8) *Patterns of Enterprise Application Architecture* [#📘](app://obsidian.md/index.html#%F0%9F%93%98) (PoEAA) **Active Record** и **Unit of Work** описываются как разные паттерны, решающие разные задачи, но на практике они часто представляют собой два разных подхода к архитектуре доступа к данным.
...
```mermaid
---
title: Сравнение Active Record и Unit of Work
---
sequenceDiagram
...
## Плюсы и Минусы (по Фаулеру [#👨](app://obsidian.md/index.html#%F0%9F%91%A8))
...
3. **Гибрид:** Вы можете использовать объекты в стиле Active Record, но отслеживать их изменения во внешнем Unit of Work (например, в Django или некоторых реализациях Hibernate). Однако Фаулер [#👨](app://obsidian.md/index.html#%F0%9F%91%A8) отмечает, что это часто приводит к путанице: "Кто главный? Объект или Unit of Work?".

## Рекомендация Фаулера [#👨](app://obsidian.md/index.html#%F0%9F%91%A8)
