...
| Принцип                        | Объяснение                                                                                                                                                               |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Декларативность**            | Вы описываете **каким должен быть результат**, а не _как его достичь_. Например: _"должна быть 1 [[EC2]]-машина с Ubuntu 22.04"_ — Terraform сам решит, как это сделать. |
...
| ------------------------------------ | -------------------------------------- | ---------------------------------------------------------------------------------------------------- | ------------------------------------------------------ |
| **[[activities/cource/инженер облачных сетей/Terraform\|Terraform]]** | HCL (HashiCorp Configuration Language) | **Мультиоблачный** — поддерживает AWS, Azure, GCP, Kubernetes, Cloudflare и т.д. Самый популярный.   | Большинство компаний (Netflix, Spotify, Airbnb)        |
...
| **Примеры**                | [[activities/cource/инженер облачных сетей/Terraform]], CloudFormation, ARM | [[Ansible]], Chef, Puppet, Bash |
...
#### **Пример: [[activities/cource/инженер облачных сетей/Terraform]] (декларативный)**
```hcl
