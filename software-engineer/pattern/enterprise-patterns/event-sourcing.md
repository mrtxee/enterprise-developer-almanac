...
| Event Store | База данных для хранения событий (например, EventStoreDB, Kafka, PostgreSQL с JSON) |
...
| Apache Kafka | Распределённый стриминг-брокер — часто используется как Event Store |
