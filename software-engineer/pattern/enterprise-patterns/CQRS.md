...
**Пример**: служба СДЭК. Есть много запросов на отслеживание посылки, которые могут создать проблемы службам курьеров и управления, которые должно вносить изменения данных.