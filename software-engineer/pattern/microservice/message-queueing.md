...
- YouTube: _“How Kafka Works”_ — канал _TechWorld with Nana_
...
Если ответ — _«Все заказы потеряются»_ — вам **срочно нужна очередь**.
...
- Админ видит: _«Ошибка отправки email для заказа #4567 — SMTP timeout»_
...
| ✅ **Логирование и алертинг** | Отправить уведомление в Slack/email: _“DLQ содержит 12 сообщений — проверьте!”_ |
...
- Book: _Designing Data-Intensive Applications_ — глава 8: Message Brokers
