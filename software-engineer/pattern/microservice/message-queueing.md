...
- В режиме Pub/Sub (см. [[publish-subscribe|publish-subscribe]]) сообщение рассылается всем подписчикам топика.
...
Главный инструмент масштабирования в MQ — **[[sharding|партиционирование]]** (partitioning). Топик разбивается на партиции, и сообщения распределяются по ним (по ключу — `order_id`, `client_id`, round-robin).
...
Расширенная модель — см. [[publish-subscribe|publish-subscribe]] и [[rabbit-mq|Point-to-Point]].
