...
**[[hash-function|Хеш-функция]]** берёт на вход любые данные и возвращает значение — **хэш** данных. Не существует обратной функции для восстановления данных по хэшу.
...
- **Декартово дерево**
- **Б-дерево**
- **[[trie|trie]] (префиксное дерево)** — пример: хранение данных для Т9
