...
2. **ApplicationContext**
    1. Внедрение зависимостей + службы `famework services`:
...
3. разделение на интерфейсы, чтобы веншние клиенты не зависили от реализации, а только от интерфейса
    1. частный случай — внедрение зависимостей `dependency injection`
