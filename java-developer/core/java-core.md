...
Для создания потока, класс должен наследоваться от `extends Thread` [[java-thread]]
...
Сколько [[software-engineer/standard/Память ЭВМ|памяти]] используют примитивные типы java
